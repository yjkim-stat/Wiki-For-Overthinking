...
- **Concepts**: [self-training](../../../../wiki/concepts/self-training.md), bootstrapping, rationale generation, [rationalization](../../../../wiki/concepts/post-hoc-rationalization.md), outcome-based filtering, chain of thought
