...
- **Datasets**: MATH (Hendrycks et al., Levels 1-2, for OvT-Math), SuperGPQA (72-domain source for OvT-General question generation), Reasoning Gym (11 reasoning task types for UnderthinkingBench), AIME'25, HMMT'25
