...
- **Concepts**: [overthinking](../../../../wiki/concepts/overthinking.md), [chain-of-thought compression](../../../../wiki/concepts/chain-of-thought-compression.md), early exit, [adaptive reasoning](../../../../wiki/concepts/adaptive-reasoning.md), representation engineering for reasoning control, long-short model collaboration, LLM routing, model consolidation (distillation and merging), speculative decoding for reasoning
- **Methods**: [DEER](../../../../wiki/methods/deer.md), CONCISE, [NOWAIT](../../../../wiki/methods/nowait.md), TIP, [S-GRPO](../../../../wiki/methods/s-grpo.md), [TokenSkip](../../../../wiki/methods/tokenskip.md), Reasoning Path Compression (RPC), Adaptive GoGI-Skip, PIR, [SPIRIT](../../../../wiki/methods/spirit.md), Prune-on-Logic, [A*-Thought](../../../../wiki/methods/a-thought.md), LS-Mixture SFT, AutoL2S, [LC-R1](../../../../wiki/methods/lc-r1.md), [DAST](../../../../wiki/methods/dast.md), Thinker, LHRMs, [Ada-R1](../../../../wiki/methods/ada-r1.md), AdaCtrl, [Thinkless](../../../../wiki/methods/thinkless.md), [LASER](../../../../wiki/methods/laser.md), HAPO, [SelfBudgeter](../../../../wiki/methods/selfbudgeter.md), Adaptive Length Penalty (ALP), [SEAL](../../../../wiki/methods/seal.md), [Manifold Steering](../../../../wiki/methods/manifold-steering.md), SplitReason, ThoughtMani, CoThink, [PLAN-AND-BUDGET](../../../../wiki/methods/plan-and-budget.md), [VeriThinker](../../../../wiki/methods/verithinker.md), FoReaL-Decoding, COPE, ThinkSwitcher, RouteLLM, GraphRouter, IRT-Router, TagRouter, R2-Reasoner, Router-R1, R2R, Route-To-Reason (RTR), TwT, DAR / LiteCoT, [DRP](../../../../wiki/methods/drp.md), ReCUT, Reward-Guided Speculative Decoding (RSD), SpecRouter, SpecReason, Speculative Thinking, SCoT
