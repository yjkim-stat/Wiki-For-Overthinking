...
- **Methods**: REO-RL, Reasoning Efficiency Gap (REG), reasoning efficiency frontier, reinforcement learning with outcome reward, length-based reward RL, HGPO, [SimPO](../../../../wiki/methods/simpo.md), supervised fine-tuning, numerical integration over token budgets
