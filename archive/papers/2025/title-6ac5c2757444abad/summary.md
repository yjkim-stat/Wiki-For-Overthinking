...
- **Methods**: [A*-Thought](../../../../wiki/methods/a-thought.md), A* search, Bidirectional Importance Score (BIS), supervised fine-tuning on compressed traces, QwQ-32B, DeepSeek-R1-Distill-Qwen-32B, s1.1-32B, GPT-2 as scoring model, [Chain-of-Draft](../../../../wiki/methods/chain-of-draft.md), Break-the-Chain, [TokenSkip](../../../../wiki/methods/tokenskip.md)
