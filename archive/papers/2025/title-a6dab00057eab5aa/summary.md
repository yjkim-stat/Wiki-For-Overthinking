...
- **Methods**: [Ada-R1](../../../../wiki/methods/ada-r1.md), Hybrid-CoT, [model merging](../../../../wiki/methods/model-merging.md), bi-level preference optimization, DPO-style preference training, [DeepSeek-R1-Distill-Qwen-7B](../../../../wiki/methods/deepseek-r1-distill-qwen-7b.md), DeepSeek-R1-Distill-Qwen-1.5B, CoT-Valve (baseline), [O1-Pruner (baseline)](../../../../wiki/methods/o1-pruner-baseline.md)
