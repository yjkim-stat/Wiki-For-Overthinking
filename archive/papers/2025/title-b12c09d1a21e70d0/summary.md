...
- **Methods**: AdaReasoner, factorized action space, reinforcement learning policy optimization, pretrained reward model, Chain-of-Thought (baseline), Auto-CoT (baseline), in-context CoT (baseline), Best-of-N (baseline)
- **Datasets**: MMLU (Math), Metaphor, [TruthfulQA](../../../../wiki/datasets/truthfulqa.md), LogiQA, BRIGHTER, StepGame, CRoW, [GPQA](../../../../wiki/datasets/gpqa.md), MMLU-Chem, MedExQA
