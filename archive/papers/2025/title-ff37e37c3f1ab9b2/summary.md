...
- **Methods**: QFFT (Question-Free Fine-Tuning), Supervised Fine-Tuning on Long CoT, Difficulty-Adaptive Distillation (DAD), SFT-Shortest, DPO-Shortest, SimPO-Shortest, [O1-Pruner](../../../../wiki/methods/o1-pruner.md), RAK (Reasoning Adaptability Cohen's Kappa), AES (Accuracy-Efficiency Score), LLaMA Factory
