...
- **Concepts**: answer-evidence gap, [chain-of-thought faithfulness](../../../../wiki/concepts/chain-of-thought-faithfulness.md), [post-hoc rationalization](../../../../wiki/concepts/post-hoc-rationalization.md), KV cache compression, auditability, perturbation faithfulness, answer-chain consistency, LLM-as-a-judge, [causal intervention](../../../../wiki/concepts/causal-intervention.md)
