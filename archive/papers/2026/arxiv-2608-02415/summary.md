...
- **Concepts**: intent classification, linear probe, hidden-state geometry, calibration, [sample complexity](../../../../wiki/concepts/sample-complexity.md), [out-of-distribution generalization](../../../../wiki/concepts/out-of-distribution-generalization.md), adversarial robustness, [uncertainty quantification](../../../../wiki/concepts/uncertainty-quantification.md), [routing](../../../../wiki/concepts/routing.md), [superposition](../../../../wiki/concepts/superposition.md)
- **Methods**: VecStat, NormStat, [linear probe](../../../../wiki/methods/linear-probe.md), multilayer perceptron classifier, KL divergence scoring, cosine similarity, [LLM-as-a-judge](../../../../wiki/methods/llm-as-a-judge.md)
