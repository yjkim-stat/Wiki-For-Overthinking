...
- **Concepts**: [latent reasoning](../../../../wiki/concepts/latent-reasoning.md), world model, [foresight](../../../../wiki/concepts/foresight.md), task specification, representation learning, causal intervention, self-supervised learning, robotic manipulation, flow matching
