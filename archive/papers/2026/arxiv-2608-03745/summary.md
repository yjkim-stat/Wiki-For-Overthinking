...
- **Methods**: Targeted Reasoning Replacement, difference-of-means probe, [activation steering](../../../../wiki/methods/activation-steering.md), [contrastive activation addition](../../../../wiki/methods/contrastive-activation-addition.md), attention-mask ablation, [linear probe](../../../../wiki/methods/linear-probe.md)
