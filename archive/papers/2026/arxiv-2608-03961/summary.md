...
- **Concepts**: [test-time scaling](../../../../wiki/concepts/test-time-scaling.md), [adaptive compute allocation](../../../../wiki/concepts/adaptive-compute-allocation.md), self-consistency, best-of-N, [prompt difficulty](../../../../wiki/concepts/prompt-difficulty.md), interpretability, [uncertainty quantification](../../../../wiki/concepts/uncertainty-quantification.md), [selection signal](../../../../wiki/concepts/selection-signal.md), matched-budget comparison
