...
- **Concepts**: test-time scaling, [adaptive compute allocation](../../../../wiki/concepts/adaptive-compute-allocation.md), self-consistency, best-of-N, [prompt difficulty](../../../../wiki/concepts/prompt-difficulty.md), interpretability, [uncertainty quantification](../../../../wiki/concepts/uncertainty-quantification.md), selection signal, matched-budget comparison
- **Methods**: fuzzy control, [best-of-N](../../../../wiki/methods/best-of-n.md), Borda count, [self-certainty](../../../../wiki/methods/self-certainty.md), compute-optimal allocation, [majority voting](../../../../wiki/methods/majority-voting.md)
