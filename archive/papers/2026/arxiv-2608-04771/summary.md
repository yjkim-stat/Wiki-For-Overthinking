...
- **Concepts**: [overthinking](../../../../wiki/concepts/overthinking.md), process reward, [reasoning redundancy](../../../../wiki/concepts/reasoning-redundancy.md), KV cache compression, early exit, adaptive compute allocation, reflection tokens
