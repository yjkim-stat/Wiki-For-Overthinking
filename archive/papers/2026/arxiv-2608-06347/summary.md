...
- **Concepts**: [cross-lingual transfer](../../../../wiki/concepts/cross-lingual-transfer.md), reasoning pivot, [process supervision](../../../../wiki/concepts/process-supervision.md), [credit assignment](../../../../wiki/concepts/credit-assignment.md), privileged information, [token selection](../../../../wiki/concepts/token-selection.md), surface realization
