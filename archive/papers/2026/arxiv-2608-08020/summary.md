...
- **Methods**: [beam search](../../../../wiki/methods/beam-search.md), [self-consistency](../../../../wiki/methods/self-consistency.md), prefix caching, [Monte Carlo tree search](../../../../wiki/methods/monte-carlo-tree-search.md), process reward model, [linear probe](../../../../wiki/methods/linear-probe.md), [vLLM](../../../../wiki/methods/vllm.md), score-weighted majority vote
