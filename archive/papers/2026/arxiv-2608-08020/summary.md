...
- **Methods**: Gambit (thought-level beam search), STEP hidden-state scorer, prefix-caching / KV-cache-sharing branching, [Self-Consistency (baseline)](../../../../wiki/methods/self-consistency-baseline.md), [Slim-SC (baseline)](../../../../wiki/methods/slim-sc-baseline.md), [DeepConf (baseline)](../../../../wiki/methods/deepconf-baseline.md), STEP subtractive pruning (baseline)
