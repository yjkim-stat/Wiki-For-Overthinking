...
- **Methods**: [activation steering](../../../../wiki/methods/activation-steering.md), [contrastive activation addition](../../../../wiki/methods/contrastive-activation-addition.md), ablation, primal-dual optimization, KL divergence, [LLM-as-a-judge](../../../../wiki/methods/llm-as-a-judge.md), GCG, AutoDAN, PAIR
- **Datasets**: JailbreakBench, Alpaca, XSTest
