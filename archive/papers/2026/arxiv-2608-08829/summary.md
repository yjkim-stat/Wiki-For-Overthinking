...
- **Concepts**: [steering vector](../../../../wiki/concepts/steering-vector.md), layer selection, per-instance intervention, over-steering, fluency collapse, [detection versus control](../../../../wiki/concepts/detection-versus-control.md), saturation, [Shapley value](../../../../wiki/concepts/shapley-value.md), sub-additivity
