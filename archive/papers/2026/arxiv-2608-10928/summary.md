...
- **Concepts**: [sequential test-time scaling](../../../../wiki/concepts/sequential-test-time-scaling.md), diminishing/negative returns from longer reasoning traces, retrieval-augmented reasoning, in-context exemplar injection at each reasoning step, predictive entropy of final answers as a proxy for reasoning quality
...
- **Datasets**: GSM-8K, [MATH-500](../../../../wiki/datasets/math-500.md), [AIME 2025](../../../../wiki/datasets/aime-2025.md), SciQ, NuminaMath-1.5 (synthetic split, used as external example corpus)
