...
- **Concepts**: claim-level falsification, signal dilution, test-time scaling, reliability weighting, verifier-free verification, answer aggregation, consensus, rescue rate, budget parity
