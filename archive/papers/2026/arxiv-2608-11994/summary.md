...
- **Concepts**: claim-level falsification, signal dilution, [test-time scaling](../../../../wiki/concepts/test-time-scaling.md), reliability weighting, [verifier-free verification](../../../../wiki/concepts/verifier-free-verification.md), answer aggregation, [consensus](../../../../wiki/concepts/consensus.md), rescue rate, budget parity
