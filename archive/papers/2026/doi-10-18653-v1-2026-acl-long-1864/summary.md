...
- **Methods**: AdaMix (dual-adapter decoupled optimization + difficulty-aware routing), [LoRA](../../../../wiki/methods/lora.md), [GRPO](../../../../wiki/methods/grpo.md), task arithmetic (adapter interpolation), [DPO (baseline)](../../../../wiki/methods/dpo-baseline.md), ShorterBetter (baseline), [TLMRE (baseline)](../../../../wiki/methods/tlmre-baseline.md), ModelMerging (baseline), [CoT-Valve (baseline)](../../../../wiki/methods/cot-valve-baseline.md), SwitchCoT (baseline)
