...
- **Methods**: WHISPER (iterative persuasive-prompt refinement), NoThinking (baseline), 'Be concise' prompting (baseline), Chain-of-Draft (baseline), GEPA (reflective prompt optimization, baseline), DEER (white-box inference intervention, reference)
