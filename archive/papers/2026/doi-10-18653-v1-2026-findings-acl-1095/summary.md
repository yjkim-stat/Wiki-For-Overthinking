...
- **Methods**: ThinkBrake (log-margin early stopping), ThinkBrake-p (raw probability-gap variant), [NoWait (baseline)](../../../../wiki/methods/no-wait-baseline.md), [ThinkLess (baseline)](../../../../wiki/methods/thinkless-baseline.md), [Dynasor-CoT (baseline)](../../../../wiki/methods/dynasor-cot-baseline.md), [DEER (baseline)](../../../../wiki/methods/deer-baseline.md), Direct Preference Optimization (DPO) on ThinkBrake data
