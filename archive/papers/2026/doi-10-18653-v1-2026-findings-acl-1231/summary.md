...
- **Methods**: NEAT (neuron-based early exit), [NoThinking (baseline)](../../../../wiki/methods/nothinking-baseline.md), TALE (baseline), Dynasor (baseline), DEER (baseline), CGRS (baseline), vLLM (inference framework)
