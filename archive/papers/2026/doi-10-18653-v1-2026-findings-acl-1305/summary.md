...
- **Methods**: VecCISC (+KMeans / +HAC), [Confidence-Informed Self-Consistency (CISC, baseline)](../../../../wiki/methods/confidence-informed-self-consistency-cisc-baseline.md), [Self-Consistency (SC, baseline)](../../../../wiki/methods/self-consistency-sc-baseline.md), VecCISC (random), ablation
