...
- **Concepts**: [overthinking](../../../../wiki/concepts/overthinking.md), reward shaping, [credit assignment](../../../../wiki/concepts/credit-assignment.md), dual-process theory, [Pareto frontier](../../../../wiki/concepts/pareto-frontier.md), [adaptive compute allocation](../../../../wiki/concepts/adaptive-compute-allocation.md), mode selection
- **Methods**: ADaPT, [reinforcement learning post-training](../../../../wiki/methods/reinforcement-learning-post-training.md), mode-selection token, length control
