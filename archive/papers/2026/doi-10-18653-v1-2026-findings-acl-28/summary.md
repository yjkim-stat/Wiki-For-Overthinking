...
- **Concepts**: [multimodal reasoning](../../../../wiki/concepts/multimodal-reasoning.md), scientific reasoning, process evaluation, traceability, domain expertise, multi-step inference
