...
- **Concepts**: [sample complexity](../../../../wiki/concepts/sample-complexity.md), VC dimension, [generalization](../../../../wiki/concepts/generalization.md), teacher forcing, [expressivity-learnability gap](../../../../wiki/concepts/expressivity-learnability-gap.md), inductive bias, hard attention, chain of thought
