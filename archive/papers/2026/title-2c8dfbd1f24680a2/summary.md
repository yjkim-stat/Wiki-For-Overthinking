...
- **Methods**: Retrieval-of-Thought (RoT), thought graph, reward-guided traversal, Thinking Intervention, [retrieval-augmented generation](../../../../wiki/methods/retrieval-augmented-generation.md), Buffer of Thoughts, chain-of-thought, [self-consistency](../../../../wiki/methods/self-consistency.md)
