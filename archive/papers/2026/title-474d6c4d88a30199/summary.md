...
- **Concepts**: [Overthinking](../../../../wiki/concepts/overthinking.md), Reflection in reasoning traces, [Length reward](../../../../wiki/concepts/length-reward.md), Reflection reward, Sequential revision, [Test-time compute scaling](../../../../wiki/concepts/test-time-compute-scaling.md), Online reinforcement learning for efficient reasoning, Difficulty-adaptive reasoning length
- **Methods**: REA-RL, [GRPO](../../../../wiki/methods/grpo.md), reflection reward, [sequential revision](../../../../wiki/methods/sequential-revision.md), parallel sampling, supervised fine-tuning distillation, [DeepSeek-R1-Distill-Qwen-7B](../../../../wiki/methods/deepseek-r1-distill-qwen-7b.md), Qwen2.5-7B-Instruct, Qwen2.5-32B
