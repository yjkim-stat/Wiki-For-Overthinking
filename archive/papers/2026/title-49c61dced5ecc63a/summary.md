...
- **Methods**: TRACE (Truncated Reasoning AUC Evaluation), progressive CoT truncation with forced answering, CoT monitoring baseline, [RLOO](../../../../wiki/methods/rloo.md), [GRPO](../../../../wiki/methods/grpo.md), Qwen2.5-Instruct (1.5B/3B/7B/14B/32B/72B), Llama3-8B
