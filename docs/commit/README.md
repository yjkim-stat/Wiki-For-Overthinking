...
| 0058 | [A benchmark sitting is one entity, however it was spelled](0058-a-benchmark-sitting-is-one-entity-however-spelled.md) | fix | AIME alone split across eight spellings in this archive's first backfill; `harvest` now merges the format variants |
