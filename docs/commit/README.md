...
| 0093 | [The archive moves to a repository of its own](0093-the-archive-moves-to-a-repository-of-its-own.md) | chore · breaking | Two repositories are being developed, not one being deployed; the two rhythms do not share a history || 0067 | [A note says when its own prose is behind](0067-a-note-says-when-its-own-prose-is-behind.md) | feature | Staleness was reported to whoever ran the render, not to whoever reads the note weeks later |
