...
| 0073 | [A benchmark sitting is one entity, however it was spelled](0073-a-benchmark-sitting-is-one-entity-however-spelled.md) | fix | AIME alone split across eight spellings in this archive's first backfill; `harvest` now merges the format variants |
| 0074 | [Taking the template back in](0074-taking-the-template-back-in.md) | chore | The template grew thirteen commits; this deployment had grown one, and the two disagree about whether to merge entities automatically |
| 0100 | [A source that answers 403 to everything](0100-a-source-that-answers-403-to-everything.md) | chore | OpenReview refused every request from two hosts on the same day; a standing failure is how a new one gets lost |
