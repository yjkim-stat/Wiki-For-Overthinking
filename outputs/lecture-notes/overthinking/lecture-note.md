...
- **Scaling Laws and Compute-Optimal Training Beyond Fixed Training Durations** _(not yet summarized)_
- **Repurposing Language Models into Embedding Models: Finding the Compute-Optimal Recipe** _(not yet summarized)_
- **TinyTTA: Efficient Test-time Adaptation via Early-exit Ensembles on Edge Devices** _(not yet summarized)_
- **Resolving Discrepancies in Compute-Optimal Scaling of Language Models** _(not yet summarized)_
...
- **4+3 Phases of Compute-Optimal Neural Scaling Laws** _(not yet summarized)_
