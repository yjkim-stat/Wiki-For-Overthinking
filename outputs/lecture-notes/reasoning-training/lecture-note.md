...
Built from 120 paper(s) and 0 recording(s) spanning 2022-03-28 to 2026-08-06. 108 of the papers have been read in full.
...
| 2WikiMultiHopQA | 2 | A multi-hop question-answering set built so that answering requires composing facts across two Wikipedia articles, used in both sources as an in-domain companion to HotpotQA for... |
