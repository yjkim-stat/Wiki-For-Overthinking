...
def _plural_tail(word: str) -> str:
    ...
    Two rules, applied to one word. Not stemming: this file's whole design goal
    is that somebody can read a rule and correct it, and a lemmatizer is neither
    readable nor dependency-free. Irregular plurals stay the keyword author's
    problem, which is the right place for them.
    """
