...
explaining why it is there.
    ...
    python3 scripts/retopic.py --topic my-topic
...
def main() -> int:
    ...
    cfg = config_mod.load()
    # A slug that names nothing is refused before the nothing-to-do path, not
    # after it: with no topics defined, every requested slug is unknown, and
    # exiting 0 there would tell somebody who mistyped one that it was done.
