...
# LOCAL: this deployment tracks one topic, `overthinking`, and its keyword
# list carries no accepted overlap. The pair this check found when it arrived
# -- `reasoning token` against `reasoning-token` -- was a real double count and
# was deleted from the topic file rather than recorded here.
