...
Where a model attends at a given position, read across 4 sources as a routing signal and, consistently, as one that says where the model looked rather than what it found. Its productive uses here are as an index into something else: finding the key points in a reasoning path at which to inject a safety reflection, or measuring how routing focus shifts across reasoning phases to detect hallucination. Its limitation is the archive's recurring one -- in vision-language hallucination, attention alone does not separate real from hallucinated objects and only what the attended region decodes to does. One library in the set exists to make patterns inspectable for vision-language models with the tooling text-only models already have.
...
**Related**: [activation patching](../methods/activation-patching.md), [adaptive compute allocation](adaptive-compute-allocation.md), [aha moment](aha-moment.md), [attention analysis](../methods/attention-analysis.md), [chain-of-thought prompting](../methods/chain-of-thought-prompting.md), [Coconut](../methods/coconut.md), [Gemini-1.5-Pro](../models/gemini-1-5-pro.md), [GPT-4o](../models/gpt-4o.md), [grounding](grounding.md), [GRPO](../methods/grpo.md), [Inference Time Intervention](../methods/inference-time-intervention.md), [jailbreak](jailbreak.md), [Kimi-K2.5](../models/kimi-k2-5.md), [knowledge distillation](../methods/knowledge-distillation.md), [latent reasoning](latent-reasoning.md), [LLaVA-1.5](../models/llava-1-5.md), [LLaVA-OneVision-7B](../models/llava-onevision-7b.md), [localization](localization.md), [logit lens](../methods/logit-lens.md), [mechanistic interpretability](mechanistic-interpretability.md), [monitorability](monitorability.md), [process supervision](process-supervision.md), [Qwen2.5-VL](../models/qwen2-5-vl.md), [Qwen2.5-VL-7B-Instruct](../models/qwen2-5-vl-7b-instruct.md), [Qwen3-VL](../models/qwen3-vl.md), [reproducibility](reproducibility.md), [supervised fine-tuning](../methods/supervised-fine-tuning.md), [TempCompass](../datasets/tempcompass.md), [test-time compute](test-time-compute.md), [test-time scaling](test-time-scaling.md), [verifiable reward](verifiable-reward.md), [verification](verification.md), [Video-MME](../datasets/video-mme.md), [visual grounding](visual-grounding.md)
