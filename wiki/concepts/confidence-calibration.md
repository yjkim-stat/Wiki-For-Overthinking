...
- **Kind**: concept
- **Also called**: Confidence Calibration, calibration, confidence calibration
- **Topics**: [overthinking](../topics/overthinking.md)
- **Sources**: 3

**Related**: [adaptive test-time compute](adaptive-test-time-compute.md), [ARC-Challenge](../datasets/arc-challenge.md), [ASDiv](../datasets/asdiv.md), [best-of-N](../methods/best-of-n.md), [C4](../methods/c4.md), [Confidence-based early stopping](../methods/confidence-based-early-stopping.md), [Conformal Prediction](../methods/conformal-prediction.md), [Early Exit](../methods/early-exit.md), [early stopping](early-stopping.md), [GSM-Hard](../datasets/gsm-hard.md), [GSM8K](../datasets/gsm8k.md), [HellaSwag](../datasets/hellaswag.md), [HumanEval](../datasets/humaneval.md), [MATH](../datasets/math.md), [MATH500](../datasets/math500.md), [MathQA](../datasets/mathqa.md), [MBPP](../datasets/mbpp.md), [MMLU](../datasets/mmlu.md), [MMLU-Pro](../datasets/mmlu-pro.md), [MMMU](../datasets/mmmu.md), [Process Supervision](process-supervision.md), [Self-Consistency](../methods/self-consistency.md), [SVAMP](../datasets/svamp.md)
