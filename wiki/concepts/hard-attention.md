...
**Related**: [chain of thought](../methods/chain-of-thought.md), [chain-of-thought prompting](../methods/chain-of-thought-prompting.md), [circuit complexity](circuit-complexity.md), [compositionality](compositionality.md), [expressivity-learnability gap](expressivity-learnability-gap.md), [generalization](generalization.md), [sample complexity](sample-complexity.md), [teacher forcing](../methods/teacher-forcing.md), [VC dimension](vc-dimension.md)
