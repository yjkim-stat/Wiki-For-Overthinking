...
**Related**: [attention analysis](../methods/attention-analysis.md), [chain of thought](../methods/chain-of-thought.md), [circuit complexity](circuit-complexity.md), [expressivity](expressivity.md), [expressivity-learnability gap](expressivity-learnability-gap.md), [finite precision](finite-precision.md), [generalization](generalization.md), [gradient descent analysis](../methods/gradient-descent-analysis.md), [out-of-distribution generalization](out-of-distribution-generalization.md), [scaling laws](scaling-laws.md), [self-training](self-training.md), [state tracking](state-tracking.md), [training dynamics](training-dynamics.md)
