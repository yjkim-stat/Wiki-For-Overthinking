...
**Related**: [activation patching](../methods/activation-patching.md), [activation steering](../methods/activation-steering.md), [attention pattern](attention-pattern.md), [auditability](auditability.md), [chain of thought](../methods/chain-of-thought.md), [counterfactual intervention](../methods/counterfactual-intervention.md), [emergent behaviour](emergent-behaviour.md), [expressivity-learnability gap](expressivity-learnability-gap.md), [generalization](generalization.md), [literature survey](../methods/literature-survey.md), [localization](localization.md), [meta-evaluation](meta-evaluation.md), [parity](../datasets/parity.md), [Qwen2.5-VL](../models/qwen2-5-vl.md), [Qwen3-VL](../models/qwen3-vl.md), [reproducibility](reproducibility.md), [sample complexity](sample-complexity.md), [training dynamics](training-dynamics.md)
