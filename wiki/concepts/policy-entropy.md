...
The entropy of a policy's next-token distribution, and across 8 sources the quantity whose trajectory is the archive's best-instrumented view of what reinforcement learning does to a reasoning model. Its behaviour is consistent: collapse to near zero within a few hundred steps, coinciding with the highest training reward, after which the policy is overly confident, cannot explore, and its validation performance plateaus. The archive's related entry records the front-loading -- roughly three-quarters of both entropy consumption and performance gain in the first 200 of 2,400 steps. Two cautions the corpus supplies about using it as a signal. It does not measure exploration: high entropy can be degeneration, and one source calls a condition it examines 'entropy without exploration' outright, which is why a paired rescue-and-loss count against a reference run is the replacement several sources adopt. And it is a summary over a distribution, so it cannot distinguish stylistic from inferential narrowing -- the branch-preference measurement that can find the collapse stronger in a semantic contrast than a syntactic one. Where it is used well it is as a control rather than a target: one source reports its post-initialisation entropy at 0.047 against a baseline's 0.029 precisely to show its improvement did not come from collapsing diversity.
...
**Related**: [advantage estimation](advantage-estimation.md), [advantage function](advantage-function.md), [AIME](../datasets/aime.md), [AIME 2024](../datasets/aime-2024.md), [AIME 2025](../datasets/aime-2025.md), [AMC](../datasets/amc.md), [AMC23](../datasets/amc23.md), [backtracking](backtracking.md), [best-of-n](../methods/best-of-n.md), [calibration](calibration.md), [Clip-Cov](../methods/clip-cov.md), [clip-higher](../methods/clip-higher.md), [covariance of probability and advantage](covariance-of-probability-and-advantage.md), [DAPO](../methods/dapo.md), [DAPO-Math-17K](../datasets/dapo-math-17k.md), [DAPO-Qwen-32B](../models/dapo-qwen-32b.md), [data efficiency](data-efficiency.md), [entropy bonus](entropy-bonus.md), [entropy collapse](entropy-collapse.md), [entropy regularization](../methods/entropy-regularization.md), [exploration](exploration.md), [exploration-exploitation trade-off](exploration-exploitation-trade-off.md), [Game of 24](../datasets/game-of-24.md), [gpt-5.6-luna](../models/gpt-5-6-luna.md), [gpt-oss-120b](../models/gpt-oss-120b.md), [GRPO](../methods/grpo.md), [GSM8K](../datasets/gsm8k.md), [GSPO](../methods/gspo.md), [IFEval](../datasets/ifeval.md), [KL-Cov](../methods/kl-cov.md), [knowledge distillation](../methods/knowledge-distillation.md), [KodCode](../datasets/kodcode.md), [LiveCodeBench](../datasets/livecodebench.md), [Llama-3.1-8B](../models/llama-3-1-8b.md), [Llama-3.1-8B-Instruct](../models/llama-3-1-8b-instruct.md), [LLM-as-a-judge](../methods/llm-as-a-judge.md), [long chain-of-thought distillation](../methods/long-chain-of-thought-distillation.md), [MATH](../datasets/math.md), [MATH500](../datasets/math500.md), [MBPP+](../datasets/mbpp.md), [Minerva](../datasets/minerva.md), [Mistral-7B](../models/mistral-7b.md), [OlympiadBench](../datasets/olympiadbench.md), [Omni-MATH](../datasets/omni-math.md), [on-policy self-distillation](../methods/on-policy-self-distillation.md), [pass@k](pass-k.md), [performance ceiling](performance-ceiling.md), [Phi-4](../models/phi-4.md), [policy gradient](policy-gradient.md), [policy gradient masking](../methods/policy-gradient-masking.md), [post-hoc rationalization](post-hoc-rationalization.md), [PPO](../methods/ppo.md), [PRIME](../methods/prime.md), [privileged information](privileged-information.md), [prompt difficulty](prompt-difficulty.md), [Qwen2.5-14B-Instruct](../models/qwen2-5-14b-instruct.md), [Qwen2.5-32B](../models/qwen2-5-32b.md), [Qwen2.5-7B](../models/qwen2-5-7b.md), [Qwen2.5-7B-Instruct](../models/qwen2-5-7b-instruct.md), [Qwen2.5-Math-7B](../models/qwen2-5-math-7b.md), [Qwen3-1.7B-Base](../models/qwen3-1-7b-base.md), [Qwen3-4B-Base](../models/qwen3-4b-base.md), [Qwen3-8B-Base](../models/qwen3-8b-base.md), [reasoning boundary](reasoning-boundary.md), [REINFORCE](../methods/reinforce.md), [reward sparsity](reward-sparsity.md), [RLOO](../methods/rloo.md), [RLVR](../methods/rlvr.md), [scaling laws](scaling-laws.md), [softmax policy](softmax-policy.md), [supervised fine-tuning](../methods/supervised-fine-tuning.md), [tabular softmax parameterization](tabular-softmax-parameterization.md), [token-level entropy](token-level-entropy.md), [training dynamics](training-dynamics.md), [trajectory diversity](trajectory-diversity.md), [VeRL](../methods/verl.md)
...
### Revised at nine sources: the random control is now a pattern, not an anomaly

The section "Is entropy the mechanism, or the language we describe it in?" rests
its first horn on a single observation — that zeroing gradients on a *randomly
chosen* subset of positive-advantage tokens performed comparably to selecting
them by covariance, and that the paper reported this without dwelling on it.
That observation is no longer isolated. Two further results of the same shape
have arrived, on different interventions:

| Targeted criterion | Randomized control | Gap |
| --- | --- | --- |
| Covariance-selected positive-advantage tokens | Randomly selected ones | comparable |
| Cue-derived partition of correct completions, rarity-reweighted | **Random partition**, same reweighting | random recovers 1.45 of 3.55; cues add 2.10 |
| Reward-guided latent optimization | **Reward-free random walk** in the same space | 60.3% vs 60.6% |

In none of the three does the random arm match fully, so the criteria are doing
something. What the pattern establishes is narrower and more useful: **the
untested attribution is routinely wrong about how much.** Recorded as
finding:160beee59d4d83b6.

**Why this belongs in this note specifically.** Every intervention above was
motivated as targeting a quantity — covariance with advantage, structural
rarity, reward gradient — and in each case a control that destroys the targeting
while preserving the *mechanical* change (fewer effective gradients, a
non-uniform weight distribution, a perturbation in the right space) keeps much
of the benefit. That is exactly the dichotomy this note has been unable to
resolve for entropy, now visible in three neighbouring literatures at once. It
raises the prior that entropy is a statistic that moves when something coarser
is controlled, without settling it.

**The discriminating experiment, restated and now cheaper.** This note has asked
twice for one that varies the selection criterion while holding the reduction in
effective gradient fixed. The rarity paper comes closest to running it and stops
one step short: it reports random-partition and cue-partition arms but does not
equalize the resulting weight *distributions* between them, so the 2.10-point
