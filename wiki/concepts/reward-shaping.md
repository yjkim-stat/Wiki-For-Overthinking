...
**Related**: [Accuracy-Efficiency Tradeoff](accuracy-efficiency-tradeoff.md), [adaptive reasoning](adaptive-reasoning.md), [AIME 2024](../datasets/aime-2024.md), [AMC23](../datasets/amc23.md), [GPQA](../datasets/gpqa.md), [LiveCodeBench](../datasets/livecodebench.md), [MATH](../datasets/math.md), [Minerva Math](../datasets/minerva-math.md), [MMLU](../datasets/mmlu.md), [OlympiadBench](../datasets/olympiadbench.md), [overthinking](overthinking.md), [test-time compute](test-time-compute.md)
