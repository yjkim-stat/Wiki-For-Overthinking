...
**Related**: [adaptive compute allocation](adaptive-compute-allocation.md), [best-of-n](../methods/best-of-n.md), [Borda count](../methods/borda-count.md), [GSM8K](../datasets/gsm8k.md), [LLaVA-OneVision-7B](../models/llava-onevision-7b.md), [majority voting](../methods/majority-voting.md), [matched-budget comparison](matched-budget-comparison.md), [MATH](../datasets/math.md), [MathVision](../datasets/mathvision.md), [MMMU](../datasets/mmmu.md), [paired bootstrap confidence intervals](../methods/paired-bootstrap-confidence-intervals.md), [prompt difficulty](prompt-difficulty.md), [Qwen2.5-1.5B-Instruct](../models/qwen2-5-1-5b-instruct.md), [Qwen2.5-VL-7B-Instruct](../models/qwen2-5-vl-7b-instruct.md), [SciQ](../datasets/sciq.md), [self-certainty](../methods/self-certainty.md), [self-consistency](../methods/self-consistency.md), [test-time scaling](test-time-scaling.md), [uncertainty quantification](uncertainty-quantification.md), [visual grounding](visual-grounding.md)
