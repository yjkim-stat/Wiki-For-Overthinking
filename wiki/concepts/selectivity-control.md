...
**Related**: [activation patching](../methods/activation-patching.md), [activation steering](../methods/activation-steering.md), [chain of thought faithfulness](chain-of-thought-faithfulness.md), [difference-in-means direction](difference-in-means-direction.md), [KV cache](kv-cache.md), [linear probe](../methods/linear-probe.md), [linear separability](linear-separability.md), [Llama-3.2-1B](../models/llama-3-2-1b.md), [logit lens](../methods/logit-lens.md), [Mistral-7B-v0.3](../models/mistral-7b-v0-3.md), [process supervision](process-supervision.md), [Qwen2.5-coder-7B](../models/qwen2-5-coder-7b.md), [residual stream](residual-stream.md), [sparse autoencoder](../methods/sparse-autoencoder.md), [state tracking](state-tracking.md), [supervised fine-tuning](../methods/supervised-fine-tuning.md), [tuned lens](../methods/tuned-lens.md)
