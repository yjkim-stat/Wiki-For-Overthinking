...
Maintaining an accurate representation of a changing situation across many steps, and across 4 sources a capability the archive evaluates as distinct from step-wise reasoning. Its benchmarks: a chess testbed where 13 models play each other and none beats a human-amateur-level engine while some lose to random play, and a multi-turn reasoning benchmark. Its mechanism is probed directly by the scratchpad work, which edits the internal representation of a written state while holding the printed text fixed and asks whether the next step follows the transition rule applied to the edited value -- a causal test with a single correct answer, whose move-specific selectivity gaps of +0.57 and +0.68 show the model combining the edited state with the supplied move. One theoretical source proves length generalisation for a procedure over states, which is the formal counterpart.
...
**Related**: [activation patching](../methods/activation-patching.md), [attention analysis](../methods/attention-analysis.md), [belief state](belief-state.md), [chain of thought](chain-of-thought.md), [chain of thought faithfulness](chain-of-thought-faithfulness.md), [circuit complexity](circuit-complexity.md), [construct validity](construct-validity.md), [expressivity-learnability gap](expressivity-learnability-gap.md), [gradient descent analysis](../methods/gradient-descent-analysis.md), [KV cache](kv-cache.md), [length generalization](length-generalization.md), [linear probe](../methods/linear-probe.md), [long-horizon agency](long-horizon-agency.md), [long-horizon reasoning](long-horizon-reasoning.md), [Mistral-7B-v0.3](../models/mistral-7b-v0-3.md), [multi-turn reasoning](../methods/multi-turn-reasoning.md), [pattern recognition versus reasoning](pattern-recognition-versus-reasoning.md), [process supervision](process-supervision.md), [Qwen2.5-Coder-7B](../models/qwen2-5-coder-7b.md), [Qwen3-8B](../models/qwen3-8b.md), [representation editing](../methods/representation-editing.md), [residual stream](residual-stream.md), [selectivity control](../methods/selectivity-control.md), [self-training](../methods/self-training.md), [supervised fine-tuning](../methods/supervised-fine-tuning.md), [training dynamics](training-dynamics.md)
