...
**Related**: [accuracy-efficiency tradeoff](accuracy-efficiency-tradeoff.md), [Ada-GRPO](../methods/ada-grpo.md), [AIME 2024](../datasets/aime-2024.md), [AIME 2025](../datasets/aime-2025.md), [AMC23](../datasets/amc23.md), [BBH](../datasets/bbh.md), [CommonsenseQA](../datasets/commonsenseqa.md), [DeepScaleR](../datasets/deepscaler.md), [GPQA](../datasets/gpqa.md), [GRPO](../methods/grpo.md), [GSM8K](../datasets/gsm8k.md), [HotpotQA](../datasets/hotpotqa.md), [Length Penalty](length-penalty.md), [MATH](../datasets/math.md), [Minerva](../datasets/minerva.md), [Natural Questions](../datasets/natural-questions.md), [Overthinking](overthinking.md), [Reasoning Trace Length](reasoning-trace-length.md), [StrategyQA](../datasets/strategyqa.md), [SVAMP](../datasets/svamp.md), [Test-Time Compute Scaling](test-time-compute-scaling.md), [Token Budget](token-budget.md)
