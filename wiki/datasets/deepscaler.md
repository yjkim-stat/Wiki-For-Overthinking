...
**Related**: [Accuracy-Efficiency Tradeoff](../concepts/accuracy-efficiency-tradeoff.md), [AIME 2024](aime-2024.md), [AIME 2025](aime-2025.md), [AMC23](amc23.md), [DAPO](../methods/dapo.md), [DAPO-Math-17k](dapo-math-17k.md), [DeepSeek-R1-Distill-Qwen-7B](deepseek-r1-distill-qwen-7b.md), [GRPO](../methods/grpo.md), [GSM8K](gsm8k.md), [Length reward](../concepts/length-reward.md), [MATH-500](math-500.md), [Minerva Math](minerva-math.md), [OlympiadBench](olympiadbench.md), [Omni-MATH](omni-math.md), [overthinking](../concepts/overthinking.md), [Reinforcement Learning with Verifiable Rewards](../methods/reinforcement-learning-with-verifiable-rewards.md), [RLVR](../methods/rlvr.md), [sequential revision](../methods/sequential-revision.md), [Still](still.md), [supervised fine-tuning](../methods/supervised-fine-tuning.md), [test-time compute scaling](../concepts/test-time-compute-scaling.md), [Token Budget](../concepts/token-budget.md)
