...
**Related**: [AIME](aime.md), [AIME 2025](aime-2025.md), [AMC23](amc23.md), [ARC-Challenge](arc-challenge.md), [ASDiv](asdiv.md), [C4](../methods/c4.md), [Chain-of-Thought (CoT)](../methods/chain-of-thought-cot.md), [COCONUT](../methods/coconut.md), [CODI](../methods/codi.md), [CoLaR](../methods/colar.md), [Confidence Calibration](../concepts/confidence-calibration.md), [Direct Prompting](../methods/direct-prompting.md), [Early Exit](../methods/early-exit.md), [GPQA](gpqa.md), [GPT-4o-mini](../models/gpt-4o-mini.md), [GRPO](../methods/grpo.md), [GSM8K](gsm8k.md), [GSM8K-Test](gsm8k-test.md), [HellaSwag](hellaswag.md), [HumanEval](humaneval.md), [Latent reasoning](../concepts/latent-reasoning.md), [LLaMA-3-8B-Instruct](../models/llama-3-8b-instruct.md), [majority voting / self-consistency](../methods/majority-voting-self-consistency.md), [MATH](math.md), [MATH500](math500.md), [MBPP](mbpp.md), [MMLU](mmlu.md), [Multi-Agent Debate](../methods/multi-agent-debate.md), [MultiArith](multiarith.md), [Qwen2.5-7B-Instruct](../models/qwen2-5-7b-instruct.md), [RLOO](../methods/rloo.md), [self-refine](../methods/self-refine.md), [SVAMP](svamp.md), [Test-Time Scaling](../concepts/test-time-scaling.md), [Thinking Budget](../concepts/thinking-budget.md)
