...
- **Kind**: dataset
- **Also called**: OpenR1-Math-220K
- **Topics**: [overthinking](../topics/overthinking.md)
- **Sources**: 3

**Related**: [2WikiMultihopQA](2wikimultihopqa.md), [AIME 2024](aime-2024.md), [AIME 2025](aime-2025.md), [AlpacaEval 2.0](alpacaeval-2-0.md), [AMC23](amc23.md), [Bamboogle](bamboogle.md), [CommonsenseQA](commonsenseqa.md), [Deepseek-R1-1.5B](../models/deepseek-r1-1-5b.md), [GPQA](gpqa.md), [GPQA-Diamond](gpqa-diamond.md), [GPT-4o](../models/gpt-4o.md), [GRPO](../methods/grpo.md), [GSM8K](gsm8k.md), [HotpotQA](hotpotqa.md), [KAOYAN](kaoyan.md), [LiveCodeBench-v6](livecodebench-v6.md), [LLaMA-3.1-8B-Instruct](../models/llama-3-1-8b-instruct.md), [Llama-Nemotron-Post-Training-Dataset](llama-nemotron-post-training-dataset.md), [MATH500](math500.md), [MBPP](mbpp.md), [MMLU STEM](mmlu-stem.md), [MuSiQue](musique.md), [OlympiadBench](olympiadbench.md), [OpenCodeReasoning](opencodereasoning.md), [OpenMathReasoning](openmathreasoning.md), [Overthinking](../concepts/overthinking.md), [Qwen2.5-1.5B-Instruct](../models/qwen2-5-1-5b-instruct.md), [Qwen2.5-3B-Instruct](../models/qwen2-5-3b-instruct.md), [Qwen2.5-Math-7B-Instruct](../models/qwen2-5-math-7b-instruct.md), [reasoning hallucination](../concepts/reasoning-hallucination.md), [s1k-1.1](s1k-1-1.md), [StrategyQA](strategyqa.md), [supervised fine-tuning](../concepts/supervised-fine-tuning.md), [Test-Time Compute Scaling](../concepts/test-time-compute-scaling.md), [underthinking](../concepts/underthinking.md), [ZebraLogic](zebralogic.md)
