...
Sorry-bench is a harmfulness/safety benchmark (lower score means safer) used to measure unsafe-output rate in large reasoning models. ReasoningGuard evaluates on it alongside AdvBench as one of two harmfulness benchmarks, where its inference-time defense achieves a Harmfulness/FFR of 0.3/4.6 versus 32.9/46.4 undefended on DeepSeek-R1-Qwen-7B. The Self-Jailbreak/Chain-of-Guardrail paper uses it as its primary safety metric: vanilla Qwen3 models score as high as 45.68% (14B) despite strong reasoning; a global safety baseline (SafeKey) cuts it from 48.18% to 20.00% on Qwen3-32B but at a reasoning-accuracy cost, while CoG's targeted step-level rewrite reduces it to 7.27% while simultaneously improving reasoning benchmarks.
...
**Related**: [AdvBench](advbench.md), [AIME 2024](aime-2024.md), [DeepSeek-R1](../models/deepseek-r1.md), [DeepSeek-R1-Distill-Llama-70B](../models/deepseek-r1-distill-llama-70b.md), [DeepSeek-R1-Llama-8B](../models/deepseek-r1-llama-8b.md), [GPQA-Diamond](gpqa-diamond.md), [HumanEval](humaneval.md), [MATH500](math500.md), [MMLU](mmlu.md), [Phi-4-Reasoning](../models/phi-4-reasoning.md), [Qwen3-14B](../models/qwen3-14b.md), [Qwen3-32B](../models/qwen3-32b.md), [Qwen3-4B-Thinking-2507](../models/qwen3-4b-thinking-2507.md), [Qwen3-8B](../models/qwen3-8b.md), [QwQ-32B](../models/qwq-32b.md), [Selective loss masking](../methods/selective-loss-masking.md), [StrongReject](strongreject.md), [XSTest](xstest.md)
