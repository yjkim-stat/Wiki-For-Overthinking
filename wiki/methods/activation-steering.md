...
Adding a direction to a model's activations at inference to change its behaviour, and across 21 sources an instrument whose defaults do most of the damage attributed to the technique. Three defaults are named. The direction: choosing it by discriminability -- what the foundational method does -- can install the opposite of the intended effect, since vectors combining high separability with a strictly negative dose-response relationship are minable systematically. The site: injection layers are fixed globally per behaviour with which and how many treated as configuration, and one source shows the useful band is narrow, mid-network, and different for each model and each benchmark. The units: an apparent emergence of steerability with scale is produced entirely by raw activation units, an uncalibrated read-out metric and a fixed hand-picked operating point, and a factorial decomposition finds no significant trend in any of four cells. What the technique does establish, where controls are run, is causal direction rather than magnitude -- reducing steering strength consistently reduces reasoning token count and accuracy while leaving answer length unaffected, which is the shape of evidence the archive treats as usable. Two standing requirements follow from the corpus: report a matched null of comparable magnitude, since steering is an off-distribution intervention at a conventionally chosen strength and a degradation under it can be damage rather than mechanism; and do not read a probe's accuracy as a prediction about what steering along the same direction will do.
...
**Related**: [2WikiMultiHopQA](../datasets/2wikimultihopqa.md), [ablation](ablation.md), [activation patching](activation-patching.md), [AIME 2024](../datasets/aime-2024.md), [AIME 2025](../datasets/aime-2025.md), [AlpacaEval](../datasets/alpacaeval.md), [annotation agreement](../concepts/annotation-agreement.md), [annotation incompleteness](../concepts/annotation-incompleteness.md), [ARC-Easy](../datasets/arc-easy.md), [attention head](../concepts/attention-head.md), [Aya-expanse-8B](../models/aya-expanse-8b.md), [BBH](../datasets/bbh.md), [beam search](beam-search.md), [benchmark design](../concepts/benchmark-design.md), [bootstrap confidence intervals](bootstrap-confidence-intervals.md), [budget forcing](budget-forcing.md), [calibration](../concepts/calibration.md), [causal intervention](causal-intervention.md), [chain of thought](../concepts/chain-of-thought.md), [chain-of-thought distillation](chain-of-thought-distillation.md), [chain of thought faithfulness](../concepts/chain-of-thought-faithfulness.md), [chain-of-thought prompting](chain-of-thought-prompting.md), [circuit analysis](circuit-analysis.md), [circuit discovery](circuit-discovery.md), [class imbalance](../concepts/class-imbalance.md), [Claude Opus 4.7](../models/claude-opus-4-7.md), [CLIP](../models/clip.md), [Cohen's kappa](cohen-s-kappa.md), [construct validity](../concepts/construct-validity.md), [contrastive activation addition](contrastive-activation-addition.md), [cross-validation](cross-validation.md), [DeepSeek](../models/deepseek.md), [DeepSeek-R1-Distill-Llama-70B](../models/deepseek-r1-distill-llama-70b.md), [DeepSeek-R1-Distill-Llama-8B](../models/deepseek-r1-distill-llama-8b.md), [DeepSeek-R1-Distill-Qwen-14B](../models/deepseek-r1-distill-qwen-14b.md), [DeepSeek-R1-Distill-Qwen-32B](../models/deepseek-r1-distill-qwen-32b.md), [DeepSeek-R1-Distill-Qwen-7B](../models/deepseek-r1-distill-qwen-7b.md), [detection versus control](../concepts/detection-versus-control.md), [difference-in-means direction](difference-in-means-direction.md), [difference-of-means probe](difference-of-means-probe.md), [distribution mismatch](../concepts/distribution-mismatch.md), [expected calibration error](expected-calibration-error.md), [GCG](gcg.md), [Gemini-2.5-Flash](../models/gemini-2-5-flash.md), [Gemini-2.5-pro](../models/gemini-2-5-pro.md), [Gemma-2-27B](../models/gemma-2-27b.md), [Gemma-2-2B](../models/gemma-2-2b.md), [Gemma-2-9B](../models/gemma-2-9b.md), [Gemma-3-12B](../models/gemma-3-12b.md), [Gemma-3-4B](../models/gemma-3-4b.md), [Gemma-3-4B-it](../models/gemma-3-4b-it.md), [GPQA](../datasets/gpqa.md), [GPT-2](../models/gpt-2.md), [GPT-2 XL](../models/gpt-2-xl.md), [GPT-4](../models/gpt-4.md), [GPT-4.1-mini](../models/gpt-4-1-mini.md), [GPT-5](../models/gpt-5.md), [gpt-oss-120b](../models/gpt-oss-120b.md), [GSM8K](../datasets/gsm8k.md), [human evaluation](human-evaluation.md), [IFEval](../datasets/ifeval.md), [importance sampling](importance-sampling.md), [Inference Time Intervention](inference-time-intervention.md), [interpretability illusion](../concepts/interpretability-illusion.md), [jailbreak](../concepts/jailbreak.md), [jury aggregation](jury-aggregation.md), [KL divergence](kl-divergence.md), [knowledge distillation](knowledge-distillation.md), [layer selection](layer-selection.md), [linear probe](linear-probe.md), [linear representation hypothesis](../concepts/linear-representation-hypothesis.md), [linear separability](../concepts/linear-separability.md), [literature survey](literature-survey.md), [Llama-3.1-70B](../models/llama-3-1-70b.md), [Llama-3.1-8B](../models/llama-3-1-8b.md), [Llama-3.1-8B-Instruct](../models/llama-3-1-8b-instruct.md), [Llama-3.2-1B](../models/llama-3-2-1b.md), [Llama-3.2-1B-Instruct](../models/llama-3-2-1b-instruct.md), [Llama-3.2-3B](../models/llama-3-2-3b.md), [Llama-3.3-70B](../models/llama-3-3-70b.md), [Llama-3.3-70B-Instruct](../models/llama-3-3-70b-instruct.md), [Llama-3-8B-Instruct](../models/llama-3-8b-instruct.md), [LLM-as-a-judge](llm-as-a-judge.md), [localization](../concepts/localization.md), [logistic regression](logistic-regression.md), [logit lens](logit-lens.md), [LoRA](lora.md), [low-rank approximation](low-rank-approximation.md), [MATH500](../datasets/math500.md), [measurement invariance](../concepts/measurement-invariance.md), [mechanistic interpretability](../concepts/mechanistic-interpretability.md), [Mistral-7B](../models/mistral-7b.md), [MMLU](../datasets/mmlu.md), [MMLU-Pro](../datasets/mmlu-pro.md), [monitorability](../concepts/monitorability.md), [monosemanticity](../concepts/monosemanticity.md), [nested cross-validation](nested-cross-validation.md), [OlympiadBench](../datasets/olympiadbench.md), [operating point](../concepts/operating-point.md), [out-of-distribution generalization](../concepts/out-of-distribution-generalization.md), [overthinking](../concepts/overthinking.md), [PAIR](pair.md), [PCA](pca.md), [permutation test](permutation-test.md), [persona conditioning](persona-conditioning.md), [Phi-4](../models/phi-4.md), [Phi-4-reasoning](../models/phi-4-reasoning.md), [position bias](../concepts/position-bias.md), [prompt difficulty](../concepts/prompt-difficulty.md), [PubMedQA](../datasets/pubmedqa.md), [Qwen](../models/qwen.md), [Qwen2.5-14B](../models/qwen2-5-14b.md), [Qwen2.5-14B-Instruct](../models/qwen2-5-14b-instruct.md), [Qwen2.5-72B](../models/qwen2-5-72b.md), [Qwen2.5-7B-Instruct](../models/qwen2-5-7b-instruct.md), [Qwen3-0.6B](../models/qwen3-0-6b.md), [Qwen3-1.7B](../models/qwen3-1-7b.md), [Qwen3-14B](../models/qwen3-14b.md), [Qwen3-32B](../models/qwen3-32b.md), [Qwen3-4B](../models/qwen3-4b.md), [Qwen3-4B-Thinking-2507](../models/qwen3-4b-thinking-2507.md), [Qwen3.5-2B](../models/qwen3-5-2b.md), [Qwen3-8B](../models/qwen3-8b.md), [QwQ-32B](../models/qwq-32b.md), [randomized control](../concepts/randomized-control.md), [reasoning trajectory](../concepts/reasoning-trajectory.md), [representation editing](representation-editing.md), [representation versus readout](../concepts/representation-versus-readout.md), [reproducibility](../concepts/reproducibility.md), [residual stream](../concepts/residual-stream.md), [ridge regression](ridge-regression.md), [ROC analysis](roc-analysis.md), [safety alignment](../concepts/safety-alignment.md), [SciQ](../datasets/sciq.md), [selection bias](../concepts/selection-bias.md), [selectivity control](selectivity-control.md), [self-consistency](self-consistency.md), [self-repair](../concepts/self-repair.md), [Shapley value](../concepts/shapley-value.md), [shortcut learning](../concepts/shortcut-learning.md), [sparse autoencoder](sparse-autoencoder.md), [sparse dictionary learning](sparse-dictionary-learning.md), [steering vector](steering-vector.md), [structured chain of thought](structured-chain-of-thought.md), [superposition](../concepts/superposition.md), [supervised fine-tuning](supervised-fine-tuning.md), [sycophancy](../concepts/sycophancy.md), [synthetic data generation](synthetic-data-generation.md), [t-SNE](t-sne.md), [test-time compute](../concepts/test-time-compute.md), [test-time scaling](../concepts/test-time-scaling.md), [the Pile](../datasets/the-pile.md), [theory of mind](../concepts/theory-of-mind.md), [TruthfulQA](../datasets/truthfulqa.md), [tuned lens](tuned-lens.md), [Vicuna-7B](../models/vicuna-7b.md), [WikiText-2](../datasets/wikitext-2.md), [XSTest](../datasets/xstest.md), [zero-shot prompting](zero-shot-prompting.md)
...
### At twenty: the checklist's first item, finally run

Everything above argues that a steering claim needs a null. *Reproducing and
Stress-Testing Two Approaches to LLM Reasoning Reliability* is the entry that
runs one against a published method and reports what falls out.

The setup is the standard one. A held-out linear probe finds a logic-validity
direction at **0.82** accuracy — by the usual standard, enough to license the
intervention. Then:

- Sweeping a **random direction of the same norm** over the same strength range
  traces **the same curve** as the supervised one. Not a weaker effect. The same
  curve.
- Decoding the trained projector at *exactly the sub-layer where the probe
  peaks* leaves the target metric unchanged on both models (p = 0.90, 0.40).
- The additive intervention gives no consistent gain anywhere in its sweep.

**The layer profile explains it rather than merely recording it.** Probe accuracy
is 0.82 at the single best sub-layer and **0.52 — chance — pooled over the layer
range the method actually edits**, while the same probe on a *semantic* attribute
reaches 0.95 across all layers. So logic validity is encoded weakly and locally
where semantic attributes are encoded strongly and globally. That is a testable
prediction about which concepts representation editing transfers to, and it is
available from a probe sweep before any intervention is attempted.

### A one-line diagnostic for gated interventions

The same study implements a conditional steering gate faithfully and finds it
**inert**: it fires on **98% of tokens**, so it behaves as static steering. The
cause is mechanical — the gate is 0.88-separable on its *reference* sentences,
but reference and task activations come from different distributions, so nearly
every task token classifies as steer-worthy.

**Check the firing rate.** It separates a working gate from an inert one in one
line, and no accuracy number will reveal the difference.

### The one thing that worked, and its three conditions

Their only positive steering result needed all of: a task where reference and
steering distributions **match**; **ablating a content direction** rather than
adding the validity direction; and a model that **already performed the task**
(the other answers a constant "no" at chance, and no steering helps it). Their
conclusion — *model capability, not the intervention, is the dominant factor* —
belongs next to the unflippable ceiling recorded above.

### At twenty-one: the persona work adds a cheap check the rest of this note lacks

*"Many Are My Names"* is not a steering paper — it uses steering to *read* SAE
features, characterising the Assistant against roleplay personas and story
characters. But its methodology contributes two items to the checklist above.

**Why not ablation.** It argues explicitly against ablation as the default causal
test for an SAE feature: when a representation is split or partially redundant
across latents — which this archive documents as common — removing one produces
**false negatives**, so an ablation showing nothing has shown nothing. Their
replacement is bidirectional steering along the decoder direction, arrived at
independently of *MI-MIDI* and for a different reason.

**A two-temperature requirement.** An effect is trusted only if it holds at
**temperature 0** (reproducible) *and* **temperature 1** (not a decoding
artifact). Costs nothing. Most of this archive's steering evidence is collected
under greedy decoding alone.

They also fix the magnitude at the feature's own peak activation and then
decline to interpret dose–response, analysing only *direction and consistency* —
the honest move given that the magnitude is a convention rather than a calibrated
quantity.
