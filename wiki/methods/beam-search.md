...
**Related**: [Best-of-N sampling](best-of-n-sampling.md), [best-of-n selection](best-of-n-selection.md), [COCONUT](coconut.md), [CODI](codi.md), [CoLaR](colar.md), [GSM8K-Test](../datasets/gsm8k-test.md), [MATH500](../datasets/math500.md), [MultiArith](../datasets/multiarith.md)
