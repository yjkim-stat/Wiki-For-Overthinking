...
Finding the subset of components that accounts for a behaviour, usually by intervening on candidates and keeping those whose ablation changes the output. The archived sources apply it at three scales — indirect object identification, propositional logic, arithmetic — and one of them is a warning about the other two: which components a study reports depends on the corruption method, the evaluation metric and whether layers are patched singly or in windows, with window methods inflating apparent localization by at least 20%. Any circuit result in this archive should be read with the settings that produced it in view.

- **Kind**: method
- **Also called**: circuit identification
...
**Related**: [activation patching](activation-patching.md), [activation steering](activation-steering.md), [causal analysis](causal-analysis.md), [causal mediation analysis](causal-mediation-analysis.md), [circuit analysis](circuit-analysis.md), [contrastive activation addition](contrastive-activation-addition.md), [generalization](../concepts/generalization.md), [GPT-J 6B](../models/gpt-j-6b.md), [implicit reasoning](../concepts/implicit-reasoning.md), [Llama-3.1-8B](../models/llama-3-1-8b.md), [localization](../concepts/localization.md), [memorization](../concepts/memorization.md), [Mistral-7B](../models/mistral-7b.md), [modularity](../concepts/modularity.md), [monosemanticity](../concepts/monosemanticity.md), [Pythia-410M](../models/pythia-410m.md), [sparse autoencoder](sparse-autoencoder.md), [steering](../concepts/steering.md), [superposition](../concepts/superposition.md)
