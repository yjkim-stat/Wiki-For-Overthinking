...
CoT-Valve is cited here only as a length-control baseline that other adaptive-length methods (e.g. AdaMix) compare against and outperform on an accuracy-efficiency score; the sources do not describe how CoT-Valve itself works.

- **Kind**: method
- **Topics**: [overthinking](../topics/overthinking.md)
- **Sources**: 5

**Related**: [Ada-R1](ada-r1.md), [adaptive reasoning](../concepts/adaptive-reasoning.md), [AIME 2024](../datasets/aime-2024.md), [AIME 2025](../datasets/aime-2025.md), [AMC23](../datasets/amc23.md), [DeepSeek-R1-Distill-Llama-8B](../models/deepseek-r1-distill-llama-8b.md), [DeepSeek-R1-Distill-Qwen-1.5B](../models/deepseek-r1-distill-qwen-1-5b.md), [DeepSeek-R1-Distill-Qwen-7B](../models/deepseek-r1-distill-qwen-7b.md), [DPO (baseline)](dpo-baseline.md), [GPQA](../datasets/gpqa.md), [GPQA-Diamond](../datasets/gpqa-diamond.md), [GRPO](grpo.md), [GSM8K](../datasets/gsm8k.md), [LiveCodeBench](../datasets/livecodebench.md), [LLaMA 3.2 3B Instruct](../models/llama-3-2-3b-instruct.md), [LoRA](lora.md), [MATH500](../datasets/math500.md), [Minerva](../datasets/minerva.md), [MMLU](../datasets/mmlu.md), [MMLU-Pro](../datasets/mmlu-pro.md), [Model Merging](model-merging.md), [ModelMerging (baseline)](modelmerging-baseline.md), [NoThinking (baseline)](nothinking-baseline.md), [O1-Pruner (baseline)](o1-pruner-baseline.md), [Olympiad](../datasets/olympiad.md), [OlympiadBench](../datasets/olympiadbench.md), [Omni-MATH](../datasets/omni-math.md), [Qwen2.5-7B-Instruct](../models/qwen2-5-7b-instruct.md), [Qwen3-4B](../models/qwen3-4b.md), [ShorterBetter (baseline)](shorterbetter-baseline.md), [TLMRE (baseline)](tlmre-baseline.md), [TokenSkip (baseline)](tokenskip-baseline.md)
