...
Stopping generation before the model would stop on its own, and across 6 sources a family whose reported savings are real and whose accuracy claims need care. The measured trade: one method averages 63.06 percent accuracy at 11.1 percent token reduction across three models and three benchmarks, against 59.78 and 58.70 for two competitors -- and the same source reports that early exit does not beat unrestricted generation on accuracy, with vanilla at 45.02, 74.32 and 73.69 against its 44.44, 73.3 and 71.45. So the honest framing is a savings method with a small accuracy cost rather than a free improvement. The comparison that establishes a stopping rule is doing work is against fixed truncation at matched savings: one probe recovers 89 percent of full-trace accuracy while saving 39 percent of tokens where fixed-percentage truncation at the same savings loses 23 accuracy points. The archive's related caution is that a stopping signal built on the model's own confidence inherits its calibration, and on hard problems uniformly high confidence indicates a failure to branch rather than a settled answer.

- **Kind**: method
- **Also called**: adaptive stopping, dynamic early exit, early stopping
...
**Related**: [adaptive compute allocation](../concepts/adaptive-compute-allocation.md), [AIME 2024](../datasets/aime-2024.md), [AIME 2025](../datasets/aime-2025.md), [AMC23](../datasets/amc23.md), [answer stabilization](../concepts/answer-stabilization.md), [BigCodeBench](../datasets/bigcodebench.md), [chain of thought](../concepts/chain-of-thought.md), [chain-of-thought compression](chain-of-thought-compression.md), [chain of thought faithfulness](../concepts/chain-of-thought-faithfulness.md), [commitment boundary](../concepts/commitment-boundary.md), [DeepSeek-R1](../models/deepseek-r1.md), [DeepSeek-R1-Distill-Qwen-7B](../models/deepseek-r1-distill-qwen-7b.md), [DEER](deer.md), [Dynasor](dynasor.md), [entropy trajectory](../concepts/entropy-trajectory.md), [Gemma-4-26B-A4B-it](../models/gemma-4-26b-a4b-it.md), [GPQA-Diamond](../datasets/gpqa-diamond.md), [gpt-oss-20b](../models/gpt-oss-20b.md), [GSM8K](../datasets/gsm8k.md), [HumanEval+](../datasets/humaneval.md), [KV cache compression](kv-cache-compression.md), [length penalty](length-penalty.md), [linear probe](linear-probe.md), [LiveCodeBench](../datasets/livecodebench.md), [Llama-3.1-70B](../models/llama-3-1-70b.md), [MATH500](../datasets/math500.md), [monitorability](../concepts/monitorability.md), [Monte Carlo tree search](monte-carlo-tree-search.md), [OlympiadBench](../datasets/olympiadbench.md), [Omni-MATH](../datasets/omni-math.md), [optimal stopping](../concepts/optimal-stopping.md), [overthinking](../concepts/overthinking.md), [predictive entropy](../concepts/predictive-entropy.md), [process reward](../concepts/process-reward.md), [process reward model](../concepts/process-reward-model.md), [prompt difficulty](../concepts/prompt-difficulty.md), [Qwen2.5-7B](../models/qwen2-5-7b.md), [Qwen3-14B](../models/qwen3-14b.md), [Qwen3-4B-Thinking-2507](../models/qwen3-4b-thinking-2507.md), [QwQ-32B](../models/qwq-32b.md), [reasoning redundancy](../concepts/reasoning-redundancy.md), [reinforcement learning](reinforcement-learning.md), [self-consistency](self-consistency.md), [semantic entropy](semantic-entropy.md), [test-time compute](../concepts/test-time-compute.md), [token-level entropy](../concepts/token-level-entropy.md), [vLLM](vllm.md), [ZebraLogic](../datasets/zebralogic.md)
