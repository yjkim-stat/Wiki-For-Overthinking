...
**Related**: [Early Exit](early-exit.md), [early-exit neural networks](../concepts/early-exit-neural-networks.md), [GQA](../datasets/gqa.md), [MMStar](../datasets/mmstar.md), [POPE](../datasets/pope.md), [VizWiz](../datasets/vizwiz.md)
