...
**Related**: [Activation Patching](activation-patching.md), [activation steering](activation-steering.md), [Aha Moment](../concepts/aha-moment.md), [early stopping](../concepts/early-stopping.md), [Overthinking](../concepts/overthinking.md), [Reward Hacking](../concepts/reward-hacking.md), [sparse autoencoders (SAEs)](sparse-autoencoders-saes.md)
