...
**Related**: [activation steering](activation-steering.md), [alignment](../concepts/alignment.md), [chain of thought](chain-of-thought.md), [controllability](../concepts/controllability.md), [DeepSeek-R1](../models/deepseek-r1.md), [GPT-4o](../models/gpt-4o.md), [GPT-OSS](../models/gpt-oss.md), [gpt-oss-20b](../models/gpt-oss-20b.md), [hallucination](../concepts/hallucination.md), [instruction following](../concepts/instruction-following.md), [LLM-as-a-judge](llm-as-a-judge.md), [monitorability](../concepts/monitorability.md), [multi-turn reasoning](multi-turn-reasoning.md), [reasoning distillation](reasoning-distillation.md), [retrieval-augmented generation](retrieval-augmented-generation.md), [reward hacking](../concepts/reward-hacking.md), [supervised fine-tuning](supervised-fine-tuning.md), [sycophancy](../concepts/sycophancy.md), [verification](../concepts/verification.md)
