...
None of the three sources describe ThinkPrune's own recipe; it appears as a named comparison point. EvoThink cuts overthinking via Self-Pruning Training (deleting reasoning steps whose local conclusion repeats the previous one) plus Aha-Moment Preference Optimization (DPO on wrong-to-right preference pairs); QLPO resamples an over-generated rollout group to favour short-correct and long-incorrect trajectories; DiffAdapt trains a small probe to classify each question's difficulty and picks a matching prompt, temperature and token limit without retraining the base model.

- **Kind**: method
- **Topics**: [overthinking](../topics/overthinking.md)
- **Sources**: 3

**Related**: [Accuracy-Length Tradeoff](../concepts/accuracy-length-tradeoff.md), [Aha Moment](../concepts/aha-moment.md), [AIME 2024](../datasets/aime-2024.md), [AIME 2025](../datasets/aime-2025.md), [DEER](deer.md), [GPQA](../datasets/gpqa.md), [GRPO](grpo.md), [GSM8K](../datasets/gsm8k.md), [Hidden-State Probing](../concepts/hidden-state-probing.md), [Laser](laser.md), [MATH500](../datasets/math500.md), [Minerva](../datasets/minerva.md), [MMLU-Pro](../datasets/mmlu-pro.md), [O1-Pruner](o1-pruner.md), [OlympiadBench](../datasets/olympiadbench.md), [Overthinking](../concepts/overthinking.md), [Preference Optimization](preference-optimization.md), [Redundant Self-Verification](../concepts/redundant-self-verification.md), [TACO](../datasets/taco.md), [Thinkless](thinkless.md), [veRL](verl.md), [vLLM](vllm.md)
