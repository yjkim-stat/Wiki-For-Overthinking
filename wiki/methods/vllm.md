...
**Related**: [AIME 2024](../datasets/aime-2024.md), [AIME 2025](../datasets/aime-2025.md), [AIME 2026](../datasets/aime-2026.md), [Budget Forcing](budget-forcing.md), [DeepSeek-R1-Distill-Llama-8B](../models/deepseek-r1-distill-llama-8b.md), [GPQA-Diamond](../datasets/gpqa-diamond.md), [GPT-OSS-20B](../models/gpt-oss-20b.md), [HMMT 2025](../datasets/hmmt-2025.md), [LLM-as-a-Judge](llm-as-a-judge.md), [process reward model](process-reward-model.md), [Qwen3-8B](../models/qwen3-8b.md), [Reasoning Step Segmentation](reasoning-step-segmentation.md), [Self-Consistency](self-consistency.md), [Test-Time Compute Scaling](../concepts/test-time-compute-scaling.md)
