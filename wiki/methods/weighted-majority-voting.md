...
Weighted majority voting extends plain self-consistency by weighting each sampled trace's vote by a confidence or quality score rather than counting all votes equally, used in VecCISC (reducing the cost of Confidence-Informed Self-Consistency, which needs a separate critic-LLM call per trace) and STEP (a lightweight 2-layer-MLP step scorer evaluating parallel-reasoning trace quality with near-zero overhead).

- **Kind**: method
- **Also called**: weighted majority vote
- **Topics**: [overthinking](../topics/overthinking.md)
- **Sources**: 2

**Related**: [AIME 2025](../datasets/aime-2025.md), [AQuA-RAT](../datasets/aqua-rat.md), [CommonsenseQA](../datasets/commonsenseqa.md), [Confidence-Informed Self-Consistency (CISC, baseline)](confidence-informed-self-consistency-cisc-baseline.md), [DeepSeek-R1-0528-Qwen3-8B](../models/deepseek-r1-0528-qwen3-8b.md), [GPQA](../datasets/gpqa.md), [GPQA-Diamond](../datasets/gpqa-diamond.md), [GPT-4o-mini](../models/gpt-4o-mini.md), [HMMT25](../datasets/hmmt25.md), [Llama-3.1-8B](../models/llama-3-1-8b.md), [Llama 3.3 70B](../models/llama-3-3-70b.md), [MMLU-Pro](../datasets/mmlu-pro.md), [Qwen2.5 7B](../models/qwen2-5-7b.md), [Qwen3-4B-Thinking-2507](../models/qwen3-4b-thinking-2507.md), [Self-Consistency (SC, baseline)](self-consistency-sc-baseline.md)
