...
DeepScaleR-1.5B-Preview is a 1.5B-parameter reasoning-model checkpoint used in this archive as a backbone for studying overthinking rather than as a subject any source defines in its own right. LC-R1 (Optimizing Length Compression in Large Reasoning Models) applies it as a post-RL backbone to check that its 'invalid thinking' compression generalizes beyond directly-trained models, and a separate empirical study of reasoning length and correctness evaluates it among models that overthink easy questions and underthink hard ones. Two further sources on reasoning-length control (MathIF, and the Step-Level Advantage Selection paper) also cite it, though the archive's notes for them describe their own methods rather than how this checkpoint specifically is used.
...
**Related**: [AIME 2024](../datasets/aime-2024.md), [AIME 2025](../datasets/aime-2025.md), [AMC](../datasets/amc.md), [DeepScaler (training)](../methods/deepscaler-training.md), [DeepSeek-R1](deepseek-r1.md), [DeepSeek-R1-Distill-Qwen-1.5B](deepseek-r1-distill-qwen-1-5b.md), [DeepSeek-R1-Distill-Qwen-7B](deepseek-r1-distill-qwen-7b.md), [DPO (baseline)](../methods/dpo-baseline.md), [GPQA-Diamond](../datasets/gpqa-diamond.md), [GPT-5](gpt-5.md), [GRPO](../methods/grpo.md), [GSM8K](../datasets/gsm8k.md), [LC-R1](../methods/lc-r1.md), [LiveCodeBench](../datasets/livecodebench.md), [LSAT](../datasets/lsat.md), [MATH](../datasets/math.md), [MATH (training)](../datasets/math-training.md), [MATH500](../datasets/math500.md), [Minerva](../datasets/minerva.md), [MMLU](../datasets/mmlu.md), [O1-Pruner (baseline)](../methods/o1-pruner-baseline.md), [o3-mini](o3-mini.md), [OlympiadBench](../datasets/olympiadbench.md), [Overthinking](../concepts/overthinking.md), [Qwen3-32B](qwen3-32b.md), [QwQ-32B](qwq-32b.md), [s1-32B](s1-32b.md), [SFT (baseline)](../methods/sft-baseline.md), [underthinking](../concepts/underthinking.md)
