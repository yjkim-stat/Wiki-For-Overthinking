...
Llama-3.3-70B-Instruct is used across these sources in two distinct roles: as the model that segments and labels LRM reasoning traces by Bloom's Taxonomy cognitive level in a reasoning-trace cognitive-profiling study, and as an evaluated LLM in the POBs preferences/opinions/beliefs benchmark, where it is one of the models found to lean progressive-collectivist with only limited reliability improvement from added reasoning or self-reflection prompting. It also appears as an evaluation subject in ReTraceQA and in a token-complexity study of chain-of-thought compression, though neither of those two sources' notes report findings specific to it.

- **Kind**: model
- **Also called**: LLaMA 3.3 70B Instruct, Llama 3.3 70B Instruct
- **Topics**: [overthinking](../topics/overthinking.md)
- **Sources**: 4

**Related**: [adaptive compression](../concepts/adaptive-compression.md), [Claude-3.5-Sonnet](claude-3-5-sonnet.md), [CommonsenseQA](../datasets/commonsenseqa.md), [DeepSeek-R1](deepseek-r1.md), [DeepSeek-R1-Distill-Llama-8B](deepseek-r1-distill-llama-8b.md), [DeepSeek-R1-Distill-Qwen-1.5B](deepseek-r1-distill-qwen-1-5b.md), [DeepSeek-R1-Distill-Qwen-7B](deepseek-r1-distill-qwen-7b.md), [Gemini-2.0-Flash](gemini-2-0-flash.md), [GPT-4o](gpt-4o.md), [GPT-4o-mini](gpt-4o-mini.md), [LLaMA-3.1-8B-Instruct](llama-3-1-8b-instruct.md), [LLaMA 3.2 3B Instruct](llama-3-2-3b-instruct.md), [MATH500](../datasets/math500.md), [o1-mini](o1-mini.md), [OpenBookQA](../datasets/openbookqa.md), [Overthinking](../concepts/overthinking.md), [Phi-4-Reasoning](phi-4-reasoning.md), [Qwen2.5-72B-Instruct](qwen2-5-72b-instruct.md), [Qwen3-30B-A3B-Thinking-2507](qwen3-30b-a3b-thinking-2507.md), [Qwen3-4B-Thinking-2507](qwen3-4b-thinking-2507.md), [Reasoning Step Segmentation](../methods/reasoning-step-segmentation.md), [StrategyQA](../datasets/strategyqa.md)
