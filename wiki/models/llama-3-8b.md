...
- **Kind**: model
- **Also called**: Llama-3.1-8B, Llama3-8B
- **Topics**: [overthinking](../topics/overthinking.md)
- **Sources**: 2

**Related**: [Early Exit](../methods/early-exit.md), [GRPO](../methods/grpo.md), [Llama-3.2-1B](llama-3-2-1b.md), [Overthinking](../concepts/overthinking.md), [Qwen2.5 7B](qwen2-5-7b.md), [reasoning effort](../concepts/reasoning-effort.md), [RLOO](../methods/rloo.md), [SST-2](../datasets/sst-2.md), [T5-Large](../methods/t5-large.md)
