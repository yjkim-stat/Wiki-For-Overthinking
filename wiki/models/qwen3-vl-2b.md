...
**Related**: [advantage estimation](../concepts/advantage-estimation.md), [annotation incompleteness](../concepts/annotation-incompleteness.md), [causal intervention](../methods/causal-intervention.md), [CLIP](clip.md), [component ablation](../methods/component-ablation.md), [cosine similarity](../methods/cosine-similarity.md), [credit assignment](../concepts/credit-assignment.md), [flow matching](../methods/flow-matching.md), [foresight](../concepts/foresight.md), [GRPO](../methods/grpo.md), [hard negative mining](../methods/hard-negative-mining.md), [latent reasoning](../concepts/latent-reasoning.md), [MathVista](../datasets/mathvista.md), [MMMU](../datasets/mmmu.md), [MMMU-Pro](../datasets/mmmu-pro.md), [outcome reward](../concepts/outcome-reward.md), [process reward](../concepts/process-reward.md), [process reward model](../concepts/process-reward-model.md), [Qwen3-VL-8B](qwen3-vl-8b.md), [reward shaping](../methods/reward-shaping.md), [RLVR](../methods/rlvr.md), [self-correction](../concepts/self-correction.md), [supervised fine-tuning](../methods/supervised-fine-tuning.md), [t-SNE](../methods/t-sne.md)
